...
<div>
    <div class="radio-group">
        <div :class="toggleSelected(list.value)" v-for="(list,index) in radioList" :key="index" class="flex items-start transition-15">
            <div class="input-wrapper">
                <input v-model="checkedValue" class="mt-1" type="radio" :name="list.name" :id="list.value" :value="list.value">
            </div>
