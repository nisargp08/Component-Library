<template>
  <!-- Simple Dark navbar with search -->
    ...
    <div class="wrapper">
      <div class="sub-wrapper">
        ...
        <div class="action-wrapper pr-2">
          <!-- Search -->
          <div class="action-item search-action-item ml-3 flex-1 desktop">
            <form action="#">
              <div class="search-group">
                <div class="search-icon">
                  <svg
          ...
          <div class="flex align-center justify-between r-width">
            <!-- Notification -->
            ...
            <div class="action-item avatar-action-item ml-3">
              <div class="user-info">
                ...
                >
                  ...
                  <svg
                    class="w-6 h-6 text-gray-300 px-1"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
...
.navbar {
  ...
  .btn-transparent {
    ...
    &:focus {
      box-shadow: 0 0 0 0.15rem rgba($color: $ring-color, $alpha: 0.5);
    }
  }
  ...
  .btn-avatar {
    ...
    &:focus {
      box-shadow: 0 0 0 0.15rem rgba($color: $ring-color, $alpha: 1);
    }
    ...
    input {
      ...
      &:focus {
        ...
        box-shadow: 0 0 0 0.15rem
          rgba($color: rgba($ring-color, 1), $alpha: 0.3);
