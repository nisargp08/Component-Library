        ...
        <div class="sidebar-navigation" v-if="isSidebarOpen">
            <div class="inner-navigation">
                ...
                <div class="navigation-brand">
                    <img class="brand-logo" src="@/assets/images/survey-corps.png" alt="Logo" />
                ...
                <div class="navigation-content">
                    ...
                    <div class="vertical-navigation">
                        ...
                        <div class="sub-menu active">
                            <!-- Click events on 'sub-menu-heading' -->
                            <div class="sub-menu-heading flex align-center">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
    ...
    mounted() {
        this.subMenuEventListener();
    },
    methods: {
        // Sidebar menu - sub items open/close listener
        subMenuEventListener() {
            // Click events on  class 'sub-menu-heading'
            let subMenuHeadings = document.querySelectorAll('.sub-menu-heading');
            // Iterate through all heading and attach an event listener
            for (const heading of subMenuHeadings) {
                heading.addEventListener("click", (e) => {
                    // Toggle class 'active' on parent element on click
...
.sub-menu {
    ...
    .sub-menu-items {
        display: none; //Hidden by default - Enable it via javascript
        width: calc(100% - 2rem);
        margin-left: 2rem;
        flex-direction: column;
        ...
        // Last element in the list height only 50% to avoid overflow
        :last-child::after {
            height: 50%;
        }
    }
