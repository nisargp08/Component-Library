  ...
  methods: {
    ...
    setComponentDetails() {
      if (this.details) {
        ...
        this.currentComponentDetails = ComponentRegistry.getComponentByScopeId(
          fileScopeId
        );
      }
    },
