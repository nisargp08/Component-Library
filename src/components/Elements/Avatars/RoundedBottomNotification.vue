<template>
  <!-- Rounded avatars with bottom notifications -->
...
.rounded-bottom-notification-xs {
  img {
    width: 2rem;
    height: 2rem;
  }
...
.rounded-bottom-notification-sm {
  img {
    width: 2.5rem;
    height: 2.5rem;
  }
...
.rounded-bottom-notification-md {
  img {
    width: 3rem;
    height: 3rem;
  }
...
.rounded-bottom-notification-lg {
  img {
    width: 3.5rem;
    height: 3.5rem;
  }
...
.rounded-bottom-notification-xl {
  img {
    width: 4rem;
    height: 4rem;
  }
